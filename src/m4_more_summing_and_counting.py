...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(2, 4, 0.4)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(6, 9, 0.2)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(0, 9, 0.8)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(2, 12, 0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(4, 15, 0.7)
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    expected = 1.82897  # This is APPROXIMATELY the correct answer.
